...
public class ReflectionRefractionTests {
                ...
                scene.geometries.add( //
                                new Sphere(new Point3D(0, 0, -50), 50) //
                                                ...
                                                .setMaterial(new Material()
                                                                .setkD(0.4).setkS(0.3).setShininess(100).setKT(0.3)),
        ...
        public void twoSpheresOnMirrors() {
                Camera camera = new Camera(new Point3D(0, 0, 10000), new Vector(0, 1, 0), new Vector(0, 0, -1)) //
                ...
                scene.lights.add(new SpotLight(new Color(1020, 400, 400), new Point3D(-750, -750, -150),
                                new Vector(-1, -1, -4)) //
        ...
        public void trianglesTransparentSphere() {
                ...
                scene.lights.add(new SpotLight(new Color(700, 400, 400), new Point3D(60, 50, 0), new Vector(0, 0, -1)) //
                                .setKL(4E-5).setKQ(2E-7).setRadius(1));

                ImageWriter imageWriter = new ImageWriter("refractionShadow", 600, 600);
                Render render = new Render() //
                                .setImageWriter(imageWriter) //
                                .setCamera(camera) //
                                .setRayTrace(new RayTracerBasic(scene, 300));
        ...
        public void multigeometrytest() {
                ...
                scene.geometries.add( //
                                new Triangle(new Point3D(-100, -50, -40), new Point3D(0, -50, -40),
                                                new Point3D(-50, 0, 50)) //
                                ...
                                new Sphere(new Point3D(60, 50, -50), 30) //
                                                ...
                                                .setMaterial(new Material().setkD(0.2).setkS(0.2).setShininess(30)
                                                                .setKT(0.6)), //
                                new Sphere(new Point3D(-50, -40, 0), 40) //
                                                .setEmmission(new Color(java.awt.Color.RED)) //
                                                .setMaterial(new Material().setkD(0.2).setkS(0.2).setShininess(50)
                                                                .setKT(0.6)),
                                new Plane(new Point3D(-200, 0, -400), new Point3D(200, 0, -400),
                                                new Point3D(0, 200, -400))//
                                                                .setEmmission(new Color(20, 20, 20)) //
                                                                .setMaterial(new Material().setKR(1)));
                ...
                ImageWriter imageWriter = new ImageWriter("multigeometrytest", 600, 600);
                Render render = new Render() //
                                .setImageWriter(imageWriter) //
                                .setCamera(camera) //
                                .setRayTrace(new RayTracerBasic(scene, 1));
